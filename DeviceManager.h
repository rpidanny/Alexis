...
const char HTML_FORM_CONTROLS[] PROGMEM   = "<form action=\"/add\" method='post' style=\"padding:5px;\"><input type=\"checkbox\" name=\"alexa\" value=\"0\">Alexa Control<br><input type=\"checkbox\" name=\"mqtt\" value=\"Bike\">MQTT<br>";
