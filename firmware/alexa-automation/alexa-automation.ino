...
void postJSON(float h,float t,float hic){
  //http client
  HTTPClient http;
  http.begin("http://sensor-datalogger.herokuapp.com/api/v1/sensor");
  http.addHeader("Content-Type", "application/x-www-form-urlencoded");
  http.POST("humidity="+String(h)+"&temperature="+String(t)+"&heatIndex="+String(hic)+"&key=142c647df295c9b92c994db569ec23a6e75760a8a57e9bfa24fdfa7eaaf1d13e");
